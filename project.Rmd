...
+ We gather inflation and interest rates between the USA and Brazil, and compare their distributions. To see if they seem to follow the same distribution, or if they are different. 
+ We also want to investigate whether the inflation and interest rates are associated, if they move in the same direction. Are high inflation rates related to high interest rates and vice-versa?
...
+ And the interest rates in Brazil are left skewed.
